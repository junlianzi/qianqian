...
/*--------------------引脚定义--------------------------*/
#define SPI_SCK_HIGH		GPIO_SetBits(GPIOA,GPIO_Pin_7)	//PA5（DO）输出高
#define	SPI_SCK_LOW			GPIO_ResetBits(GPIOA,GPIO_Pin_7)	//PA5（DO）输出低

#define SPI_MOSI_HIGH		GPIO_SetBits(GPIOA,GPIO_Pin_6)	//PA7（D1）输出高
#define	SPI_MOSI_LOW		GPIO_ResetBits(GPIOA,GPIO_Pin_6)	//PA7（D1）输出低

#define OLED_RES_HIGH		GPIO_SetBits(GPIOA,GPIO_Pin_5)	//PB0（RES）输出高
#define OLED_RES_LOW		GPIO_ResetBits(GPIOA,GPIO_Pin_5)	//PB0（RES）输出低

#define OLED_DC_HIGH		GPIO_SetBits(GPIOA,GPIO_Pin_4)	//PB1（DC）输出高
#define OLED_DC_LOW			GPIO_ResetBits(GPIOA,GPIO_Pin_4)	//PB1（DC）输出低

#define SPI_CS_HIGH			GPIO_SetBits(GPIOA,GPIO_Pin_3)	//PA4（CS）输出高
#define SPI_CS_LOW			GPIO_ResetBits(GPIOA,GPIO_Pin_3)	//PA4（CS）输出低
